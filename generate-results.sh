...
if pages:
    for p in pages:
        ...
        html += f'<div class="page"><div class="page-name">{name}</div><div class="page-url">{page_url}</div><div class="elements">Elements: {en}</div></div>\n'
else:
    html += '<p>No pages found</p>'

html += '''<p><a href="../">← Back to AutoFlow</a></p>
</div>
</body>
</html>'''
